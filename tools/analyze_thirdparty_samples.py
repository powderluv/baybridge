...
SUPPORTED_NVIDIA_MARKERS = {
    ...
    "nvgpu.cpasync.create_tma_multicast_mask",
    "nvgpu.cpasync.make_tiled_tma_atom",
    "nvgpu.cpasync.copy_tensormap",
    "nvgpu.cpasync.update_tma_descriptor",
    "nvgpu.cpasync.fence_tma_desc_acquire",
    "nvgpu.cpasync.cp_fence_tma_desc_release",
    "nvgpu.cpasync.fence_tma_desc_release",
